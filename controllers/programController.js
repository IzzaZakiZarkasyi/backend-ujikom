...
export const saveProgram = (req, res)=>{
    ...
    const deskripsi_program = req.body.deskripsi_program;
    const isi_program = req.body.isi_program;
    ...
    file.mv(`./public/images/${fileName}`, async(err)=>{
        ...
        try {
            await Program.create({judul_program: judul_program, deskripsi_program: deskripsi_program, isi_program: isi_program, image: fileName, url: url});
...
export const editProgram = async(req, res)=>{
    ...
    const url = `${req.protocol}://${req.get("host")}/images/${fileName}`;
    try {
        await Program.update({judul_program: judul_program, deskripsi_program: deskripsi_program, isi_program: isi_program, image: fileName, url: url},{
            where:{
                id: req.params.id
            }
        });
